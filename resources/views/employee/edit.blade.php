                        ...
                        <div class="col">
                            ...
                            <input type="hidden" name="_method" value="PUT">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" class="form-control" value="{{old('first_name') ? old('first_name') : $employee->first_name}}" required>
                                ...
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="number" name="phone" class="form-control" value="{{old('phone') ? old('phone') : $employee->phone}}" required >
                                    @if($errors->has('phone'))
                                    <span class="errorfield">
